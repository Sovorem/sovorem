...
- [Configuration (Configuration)](#configuration-configuration)
  - [API base URL (Որ server-ին ա միանում CLI-ը)](#api-base-url-որ-server-ին-ա-միանում-cli-ը)
...
### API base URL (Որ server-ին ա միանում CLI-ը)

Default-ով CLI-ն միանում ա production-ին՝ `https://sovorem.am`։ Սովորական օգտագործման ժամանակ սա փոխելու կարիք չկա։

Եթե ուզում ես test անել լոկալ dev server-ի կամ staging-ի վրա, օգտագործիր գլոբալ `--api-url` flag-ը ցանկացած command-ի հետ։ Այն override ա անում թե՛ API-ի, թե՛ login էջի base URL-ը՝ միայն տվյալ command-ի համար (config ֆայլում ոչինչ չի պահվում).
...
Base URL-ը **չի պահվում** config ֆայլում — այն binary-ի մեջ ա (default-ը), կամ տրվում ա env/flag-ով։ Այսինքն՝ production-ի endpoint-ը փոխվում ա միայն CLI-ի նոր version-ով (`sovorem upgrade`), ոչ թե user-ի config ֆայլը խմբագրելով։

> **Նշում.** սա այլ բան ա, քան ներքևի «Base URL HTTP test-երի համար»-ը։ Վերջինս քո **սեփական** project-ի հասցեն ա HTTP-test դասերի համար, ոչ թե Sovorem-ի server-ը։
